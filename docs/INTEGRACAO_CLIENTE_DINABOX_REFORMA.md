...
### 3. API Service Tipado (`dinabox/api_service.py`)
- **Antes**: `get_customer_detail() → dict`
- **Depois**: `get_customer_detail() → DinaboxCustomerDetail`
- Tipagem completa: dados chegam validados no comercial
...
✅ **Robustez**: Trata null, vazio, múltiplos formatos  
...
- Defaults aplicados: `customer_type="pf"`, `customer_status="on"`
- Emails/phones normalizados: `[]`
- Endendereços filtrados: remove campos null
